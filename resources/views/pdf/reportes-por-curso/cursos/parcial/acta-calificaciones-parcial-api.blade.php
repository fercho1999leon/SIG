		...
		<section class="section">
			...
			<table class="table">
				<tr>
					...
					<td colspan="{{ count($insumos)+1}}" class="text-center bold uppercase">Modulo {{ $n_parcial }}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="{{ count($student->parcial[0]->insumos)+1  }}" class="text-center bold uppercase">Parcial {{ $n_parcial }}</td>
				</tr>
				@php

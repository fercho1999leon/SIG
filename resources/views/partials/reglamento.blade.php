<table class="table table__reglamento" style="line-height:7px;">
	@if ($inicial == true)
	<tr>
	...
	<tr>
		...
		<td class="" style="font-size: 9px !important;">Lidera el cumplimiento de los compromisos establecidos para la sana convivencia.</td>
		@if ($asignaturaCualitativa == true)
			<td class="no-border"width="1"></td>
			<td class="text-center uppercase">EX</td>
			<td class="uppercase">Excelente</td>
			<td style="font-size: 9px !important;">Demuestra destacado desempeño en cada fase del desarrollo del proyecto escolar lo que constituye un excelente aporte a su formación integral</td>
		@endif
	</tr>
	<tr>
		...
		<td class="" style="font-size: 9px !important;">Cumple con los compromisos establecidos para la sana convivencia social</td>
		@if ($asignaturaCualitativa == true)
			<td class="no-border"width="1"></td>
			<td class="text-center uppercase">mb</td>
			<td class="uppercase">muy bueno</td>
			<td style="font-size: 9px !important;">Demuestra muy buen desempeño en cada fase del desarrollo del proyecto escolar lo que constituye un aporte a su formación integral</td>
		@endif
	</tr>
	<tr>
		...
		<td class="" style="font-size: 9px !important;">Falla ocasionalmente en el cumplimiento de los compromisos establecidos.</td>
		@if ($asignaturaCualitativa == true)
			<td class="no-border"width="1"></td>
			<td class="text-center uppercase">b</td>
			<td class="uppercase">bueno</td>
			<td style="font-size: 9px !important;">Demuestra buen desempeño en cada fase del desarrollo del proyecto escolar lo que constituye un aporte a su formación integral</td>
		@endif
	</tr>
	<tr>
		...
		<td class="" style="font-size: 9px !important;">Falla reiteradamente en el cumplimiento de los compromisos establecidos.</td>
		@if ($asignaturaCualitativa == true)
			<td class="no-border"width="1"></td>
			<td class="text-center uppercase">r</td>
			<td class="uppercase">regular</td>
			<td style="font-size: 9px !important;">Demuestra regular desempeño en cada fase del desarrollo del proyecto escolar lo que constituye un aporte a su formación integral</td>
		@endif
	</tr>
	<tr>
		<td class="no-border"></td>
		...
		<td class="" style="font-size: 9px !important;">No cumple con los compromisos establecidos para la sana convivencia social</td>
	</tr>
	@else
	<tr>
		...
		<td class="no-border"></td>
		<td colspan="3" class="text-center uppercase bold">equivalencias cualitativas del comportamiento</td>
		@if ($asignaturaCualitativa == true || $asignaturaCualitativa == false)
			<td class="no-border"></td>
			<td colspan="3" class="text-center uppercase bold">Asignaturas Cualitativas</td>
		@endif
	</tr>
	<tr>
		...
		@if ($asignaturaCualitativa == true)
			...
			<td style="font-size: 9px !important;">Demuestra destacado desempeño en cada fase del desarrollo del proyecto escolar lo que constituye un excelente aporte a su formación integral</td>
		@endif
		@if ($asignaturaCualitativa == false)
			<td width=1" class="no-border"></td>
			<td class="text-center uppercase">Positiva</td>
			<td style="font-size: 9px !important;">Actitudes positivas en habilidades trabajadas.</td>
		@endif
	</tr>
	<tr>
		...
		@if ($asignaturaCualitativa == false)
			...
			<td style="font-size: 9px !important;">Actitudes con ciertas dificultades en habilidades trabajadas.</td>
		@endif
	</tr>
	<tr>
		...
		@if ($asignaturaCualitativa == false)
			...
			<td style="font-size: 9px !important;">Actitudes opuestas en habilidades trabajadas.</td>
		@endif
	</tr>
	<tr>

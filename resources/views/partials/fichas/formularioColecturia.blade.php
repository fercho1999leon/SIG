<div class="panel pl-1 pr-1 matricula__matriculacion">
	<div class="matricula__matriculacion-block">
		...
		<div>
			...
			@if ($numero_caja)
				<div class="matricula__matriculacion__input">
					<label for="" class="matricula__matriculacion-label">Numero de caja</label>
					<input class="form-control input-sm" type="number" name="numero_caja" value="{{old('numero_caja', $user->caja->numero_caja)}}">
				</div>
			@endif
		</div>
	</div>

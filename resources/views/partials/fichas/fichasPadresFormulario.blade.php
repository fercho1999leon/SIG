<div class="panel p-3 matricula__matriculacion">
		...
		<div>
			...
			<div class="matricula__matriculacion__input">
				...
				<select class="form-control input-sm" name="parentezco">
					...
					@foreach (config('pined.parentezcos') as $parentezco)
						<option {{old('parentezco', $padre->parentezco) === $parentezco ? 'selected' : ''}}  value="{{$parentezco}}">{{$parentezco}}</option>
					@endforeach
				</select>
			</div>
			<div class="matricula__matriculacion__input">
			...
			<div class="matricula__matriculacion__input">
				...
				<select class="form-control" name="estado_civil">
					...
					@foreach (config('pined.estados_civil') as $estado)
			...
			<div class="matricula__matriculacion__input">
				...
				<input type="text" class="form-control input-sm" name="religion" maxlength="100" value="{{old('religion', $padre->religion)}}">
			</div>
		</div>
	</div>
	<div class="matricula__matriculacion-block">
	...
	<div class="matricula__matriculacion-block">
		...
		<div>
			...
			<div class="matricula__matriculacion__input">
				...
				<input type="text" name="lugar_nacimiento" class="form-control input-sm" value="{{old('lugar_nacimiento', $padre->lugarNacimiento)}}">
			</div>
			<div class="matricula__matriculacion__input">
	...
	<div class="matricula__matriculacion-block">
		...
		<div>
			...
			<div class="matricula__matriculacion__input">
				...
				<input type="text" name="contacto_emergencia" class="form-control input-sm" value="{{old('contacto_emergencia', $padre->contactoEmergencia)}}">
			</div>
			<div class="matricula__matriculacion__input">
				<label for="" class="matricula__matriculacion-label">Telefono de emergencia:</label>
				<input type="text" name="telefono_emergencia" class="form-control input-sm" value="{{old('telefono_emergencia', $padre->telefonoEmergencia)}}">
			</div>
			<div class="matricula__matriculacion__input">
				<label for="" class="matricula__matriculacion-label">Observación(Emergencia):</label>
				<textarea class="form-control input-sm"  name="observacion_emergencia" rows="4" cols="50">{{old('observacion_emergencia', $padre->observacionEmergencia)}}</textarea>
			</div>
		</div>
	</div>
	...
	<div class="flex flex-col lg:flex-row lg:justify-between">
		<div style="{{$btn === 'CREAR' ? 'visibility:none' : 'visibility:hidden'}}">
			<div class="flex flex-column mt-4">
				...
				<span class="text-xl mb-3 flex items-center" style="font-size:16px">
					<label class="font-light mb-0" for="representante">¿Este usuario tambien es representante?</label>

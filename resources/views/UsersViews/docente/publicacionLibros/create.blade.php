        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.publicacionLibro.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("publicacion-libros.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('filiacion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="filiacion" id="filiacion" value="{{ old('filiacion', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('fecha_publicacion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="fecha_publicacion" id="fecha_publicacion" value="{{ old('fecha_publicacion', '') }}">

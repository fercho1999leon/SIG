        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.expVincColectiva.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("exp-vinc-colectivas.update", [$expVincColectiva->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('tipo_experiencia') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tipo_experiencia" id="tipo_experiencia" value="{{ old('tipo_experiencia', $expVincColectiva->tipo_experiencia) }}">
                        ...
                        <div class="form-group {{ $errors->has('programa_proyecto') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="programa_proyecto" id="programa_proyecto" value="{{ old('programa_proyecto', $expVincColectiva->programa_proyecto) }}">
                        ...
                        <div class="form-group {{ $errors->has('duracion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="duracion" id="duracion" value="{{ old('duracion', $expVincColectiva->duracion) }}">
                        ...
                        <div class="form-group {{ $errors->has('usuario') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="usuario" id="usuario" value="{{ old('usuario', $expVincColectiva->usuario) }}" step="1">

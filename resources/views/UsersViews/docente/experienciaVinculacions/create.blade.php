        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.experienciaVinculacion.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("experiencia-vinculacions.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('programa') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="programa" id="programa" value="{{ old('programa', '') }}">

        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.experienciaProfesional.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("experiencia-profesionals.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('empresa_institucion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="empresa_institucion" id="empresa_institucion" value="{{ old('empresa_institucion', '') }}">

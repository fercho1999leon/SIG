...
<div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <!--CONTENIDO PRINCIPAL-->
    <form action="{{route('updateReferenciaApa', $referencia->id)}}" method="POST">
        {{ csrf_field() }}
            ...
            <div class="row">
                    ...
                    <div class="row p-1">
                        <div class="col-sm-12 form-group">
                            ...
                            <textarea class="form-control" type="textarea" name="referencias" id="referencias" rows="5" style="resize:none"
                                required>{{$referencia->referencias}}</textarea>
                        </div>
                    </div>
                ...
                <div class="col-sm-8">
                    ...
                    <div class="row text-right mr-3">
                        <div class="col-sm-12 p-1">
                            <a class="btn btn-danger btn-lg" href="{{ route('referenciaApa', $syllabus->id) }}">Cancelar</a>
                        </div>
                    </div>
                </div>
            </div>

...
@section('content')
    <div id="page-wrapper" class="gray-bg dashbard-4">
        ...
        <div class="container-sm mt-2 bg-white text-left rounded">
            ...
            <form action="{{ route('updateDescripcionSyllabus', $descripcion_syllabus->id) }}" method="POST">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row p-1">
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea class="form-control" type="textarea" name="descripcion_asignatura"
                                    id="descripcion_asignatura" rows="4" style="resize:none"
                                    required>{{ $descripcion_syllabus->descripcion }}</textarea>
                            </div>
                        </div>
                        <div class="row p-1">
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea class="form-control" type="textarea" name="objetivo_asignatura"
                                    id="objetivo_asignatura" rows="4" style="resize:none"
                                    required>{{ $descripcion_syllabus->objetivo }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="row p-1">
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea class="form-control" type="textarea" name="resultados_asignatura"
                                    id="resultados_asignatura" rows="4" style="resize:none"
                                    required>{{ $descripcion_syllabus->resultados }}</textarea>
                            </div>
                        </div>
                        <div class="row p-1">
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea class="form-control" type="textarea" name="contribucion" id="contribucion"
                                    ...
                                    required>{{ $descripcion_syllabus->contribucion }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row p-1">
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea class="form-control" type="textarea" name="competencias" id="competencias"
                                    rows="4" style="resize:none"
                                    required>{{ $descripcion_syllabus->competencias }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row text-right mr-3">
                    <div class="col-sm-12 p-1">
                        ...
                        <a class="btn btn-danger btn-lg"
                            href="{{ route('modificarSyllabus', $descripcion_syllabus->syllabus_id) }}">Regresar</a>
                    </div>
                </div>
            </form>
        </div>

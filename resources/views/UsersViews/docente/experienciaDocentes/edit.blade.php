        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.experienciaDocente.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("experiencia-docentes.update", [$experienciaDocente->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('curso_materia_modulo') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="curso_materia_modulo" id="curso_materia_modulo" value="{{ old('curso_materia_modulo', $experienciaDocente->curso_materia_modulo) }}">
                        ...
                        <div class="form-group {{ $errors->has('institucion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="institucion" id="institucion" value="{{ old('institucion', $experienciaDocente->institucion) }}">
                        ...
                        <div class="form-group {{ $errors->has('desde') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="desde" id="desde" value="{{ old('desde', $experienciaDocente->desde) }}">
                            @if($errors->has('desde'))
                        ...
                        <div class="form-group {{ $errors->has('hasta') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="hasta" id="hasta" value="{{ old('hasta', $experienciaDocente->hasta) }}">
                            @if($errors->has('hasta'))
                        ...
                        <div class="form-group {{ $errors->has('usuario') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="usuario" id="usuario" value="{{ old('usuario', $experienciaDocente->usuario) }}">

        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.tituloGrado.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("titulo-grados.update", [$tituloGrado->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('nombre') ? 'has-error' : '' }}">
                            <label for="nombre">{{ trans('cruds.tituloGrado.fields.nombre') }}</label>
                            <input class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre', $tituloGrado->nombre) }}">
                        ...
                        <div class="form-group {{ $errors->has('codigo_senescyt') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="codigo_senescyt" id="codigo_senescyt" value="{{ old('codigo_senescyt', $tituloGrado->codigo_senescyt) }}">
                        ...
                        <div class="form-group {{ $errors->has('universidad') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="universidad" id="universidad" value="{{ old('universidad', $tituloGrado->universidad) }}">
                        ...
                        <div class="form-group {{ $errors->has('pais') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pais" id="pais" value="{{ old('pais', $tituloGrado->pais) }}">
                            @if($errors->has('pais'))
                        ...
                        <div class="form-group {{ $errors->has('ano') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ano" id="ano" value="{{ old('ano', $tituloGrado->ano) }}">
                            @if($errors->has('ano'))
                        ...
                        <div class="form-group {{ $errors->has('usuario') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="usuario" id="usuario" value="{{ old('usuario', $tituloGrado->usuario) }}" step="1">

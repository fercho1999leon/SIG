...
@section('content')
    <div id="page-wrapper" class="gray-bg dashbard-4">
        ...
        <div class="container-sm mt-2 bg-white text-left rounded">
            ...
            <form action="{{ route('updateInformacionGeneral', $informacion_general->id) }}" method="POST">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row p-1">
                            <div class="col-sm-4 form-group">
                                ...
                                <input class="form-control" type="text" name="codigo" id="codigo"
                                    value="{{ $informacion_general->codigo_asignatura }}" required>
                            </div>
                            <div class="col-sm-4 form-group">
                                ...
                                <input class="form-control text-center" type="number" id="creditos" name="creditos" max="6"
                                    value="{{ $informacion_general->creditos }}" required>
                            </div>
                            <div class="col-sm-4 form-group">
                        ...
                        <div class="row p-1">
                            <div class="col-sm-12 form-group">
                                ...
                                <input class="form-control" type="text" name="curricular" id="curricular"
                                    value="{{ $informacion_general->unidad_curricular }}" required>
                            </div>
                        ...
                        <div class="row p-1">
                            <div class="col-sm-4 form-group">
                                ...
                                <input class="form-control text-center" type="number" id="horas_semanal"
                                    name="horas_semanal" value="{{ $informacion_general->horas_semanales }}" required>
                            </div>
                            <div class="col-sm-4 form-group">
                                ...
                                <input class="form-control text-center" type="number" id="horas_clase" name="horas_clase"
                                    value="{{ $informacion_general->horas_clase }}" required>
                            </div>
                            <div class="col-sm-4 form-group">
                                ...
                                <input class="form-control text-center" type="number" id="horas_tutoria"
                                    name="horas_tutoria" value="{{ $informacion_general->horas_tutoria }}" required>
                            </div>
                        </div>
                        <div class="row p-1">
                            <div class="col-sm-2 form-group">
                                ...
                                <input class="form-control text-center" type="number" id="teoricas" name="teoricas"
                                    value="{{ $informacion_general->teoricas }}" required>
                            </div>
                            <div class="col-sm-2 form-group">
                                ...
                                <input class="form-control text-center" type="number" id="practicas" name="practicas"
                                    value="{{ $informacion_general->practicas }}" required>
                            </div>
                            <div class="col-sm-2 form-group">
                                ...
                                <input class="form-control text-center" type="number" id="autonomas" name="autonomas"
                                    value="{{ $informacion_general->autonomas }}" required>
                            </div>
                            <div class="col-sm-3 form-group">
                                ...
                                <input class="form-control text-center" type="number" id="presenciales" name="presenciales"
                                    value="{{ $informacion_general->presenciales }}" required>
                            </div>
                            <div class="col-sm-3 form-group">
                                ...
                                <input class="form-control text-center" type="number" id="virtuales" name="virtuales"
                                    value="{{ $informacion_general->virtuales }}" required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row text-right mr-3">
                    <div class="col-sm-12 p-1">
                        ...
                        <a class="btn btn-danger btn-lg"
                            href="{{ route('modificarSyllabus', $informacion_general->syllabus_id) }}">Regresar</a>
                    </div>
                </div>
            </form>
        </div>

        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.experienciaCapacitador.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("experiencia-capacitadors.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('curso_seminario') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="curso_seminario" id="curso_seminario" value="{{ old('curso_seminario', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('entidades') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="entidades" id="entidades" value="{{ old('entidades', '') }}">

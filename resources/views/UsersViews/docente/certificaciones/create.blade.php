        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.certificacione.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("certificaciones.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('registro_setec') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="registro_setec" id="registro_setec" value="{{ old('registro_setec', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('institucion_certificadora') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="institucion_certificadora" id="institucion_certificadora" value="{{ old('institucion_certificadora', '') }}">

...
<div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <!--CONTENIDO PRINCIPAL-->
    <form action="{{route('storePerfilUnidad')}}" method="POST">
        {{ csrf_field() }}
                            ...
                            <tbody class="text-center">
                                ...
                                @if ($perfil != null)
                                    <tr class="bg-white text-black">
                                        ...
                                        <th class="text-center textoUnidad">
                                            <a href="{{route('editPerfilUnidad', $perfil->id)}}" class="btn btn-primary btn-block" role="button" aria-disabled="true">Editar</a>
                                        </th>
                                    </tr>
                                @endif
                                @endif
                    ...
                    <div class="row text-right mr-3">
                        <div class="col-sm-12 p-1">
                            <a class="btn btn-primary btn-lg"
                                href="{{ route('referenciaApa', $syllabus->id) }}">Continuar</a>
                        </div>
                    </div>
                </div>
            </div>

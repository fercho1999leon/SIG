        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.seminario.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("seminarios.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('numero_horas') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="numero_horas" id="numero_horas" value="{{ old('numero_horas', '') }}">

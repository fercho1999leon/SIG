        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.articulo.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("articulos.update", [$articulo->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('titulo') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="titulo" id="titulo" value="{{ old('titulo', $articulo->titulo) }}">
                        ...
                        <div class="form-group {{ $errors->has('nombre_revista') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nombre_revista" id="nombre_revista" value="{{ old('nombre_revista', $articulo->nombre_revista) }}">
                        ...
                        <div class="form-group {{ $errors->has('codigo_issn') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="codigo_issn" id="codigo_issn" value="{{ old('codigo_issn', $articulo->codigo_issn) }}">
                        ...
                        <div class="form-group {{ $errors->has('volumen') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="volumen" id="volumen" value="{{ old('volumen', $articulo->volumen) }}">
                        ...
                        <div class="form-group {{ $errors->has('fecha_publicacion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="fecha_publicacion" id="fecha_publicacion" value="{{ old('fecha_publicacion', $articulo->fecha_publicacion) }}">
                        ...
                        <div class="form-group {{ $errors->has('usuario') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="usuario" id="usuario" value="{{ old('usuario', $articulo->usuario) }}" step="1">

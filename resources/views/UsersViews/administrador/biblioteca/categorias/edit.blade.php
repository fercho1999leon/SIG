...
<div id="page-wrapper" class="gray-bg dashbard-1">
  ...
  <div class="row wrapper">
    <div class="col-xs-12 p-1 bg-black">
      <h1 class="text-uppercase text-white" style="text-align: center">Categoria -> <span
          class="text-info">{{$categoria->slug}}</span></h1>
    </div>
  </div>
  <div class="row wrapper">
      ...
      <form action="{{route('updateCategorias', $categoria->id)}}" method="post">
        ...
        <div class="row form-group">
          <div class="col-xs-6 p-1">
            <label class="form-label" for="nombre_categoria">Nombre Categoria</label>
          </div>
          <div class="col-xs-6 p-1">
            <input class="form-control" type="text" name="nombre_categoria" id="nombre_categoria"
        ...
        <div class="row form-group text-right p-1">
          ...
          <a href="{{route('indexCategorias')}}" type="button" class="btn btn-danger btn-lg">Cancelar</a>
        </div>
      </form>
    </div>
  </div>

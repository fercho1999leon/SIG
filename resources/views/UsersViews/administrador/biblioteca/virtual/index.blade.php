        ...
        <div class="row wrapper">
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: center;">
                                                <a class="btn btn-success"
                                                    href="{{ route('BibliotecaSeccionupdate', $config->id) }}">Modificar</a>
                        ...
                        <div id="modalCrear" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('BibliotecaSeccion') }}" method="POST"
                                        ...
                                        <div class="modal-body">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-xs-6 p-1">
                                                    <input class="form-control" type="text" name="nombre_seccion"
                                                        id="nombre_seccion" required>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-xs-6 p-1">
            ...
            <div class="col-xs-12" style="min-width: min-content;">
                                ...
                                @if ($virtual != null)
                                    @foreach ($virtual as $config)
                                        <tr>
                                            ...
                                            <th style="text-align: center;">
                                                <a class="btn btn-success"
                                                    href="{{ route('BibliotecaVirtualupdate', $config->id) }}">Modificar</a>
                                                <a class="btn btn-danger autorizar"
                ...
                <div class="row wrapper text-right">
                    <div class="col-xs-12 bg-white p-1">
                        {{-- CREACIÓN --}}
                        <button type="button" class="btn btn-primary btn-lg" id="btnAddBiblioteca" data-toggle="modal"
                            data-target="#modalCrearbiblioteca">Crear
                        ...
                        <div id="modalCrearbiblioteca" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('BibliotecaVirtual') }}" method="POST"
                                        enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="modal-body">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-xs-6 p-1">
                                                    <input class="form-control" type="text" name="nombre_biblioteca"
                                                        id="nombre_biblioteca" required>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-xs-6 p-1">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-xs-6 p-1">
                                                    <input class="form-control" type="text" name="url_biblioteca"
                                                        id="url_biblioteca" required>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-xs-6 p-1">
                                                ...
                                                <div class="col-xs-6 p-1">
                                                    <select class="form-control" name="seccion" id="seccion" required>
                                                        @foreach ($seccion as $secci)
                                                            <option value="{{ $secci->id }}">{{ $secci->seccion }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>

...
<div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="row wrapper white-bg titulo-separacion noBefore">
        <div class="col-xs-12 titulo-separacion">
            <h2 class="title-page">Semestres</h2>
        </div>
        ...
        <a href="crearCarreraSemestre/{{$id}}">
            <button class="btn dirConfiguraciones__instituto--agregarInfo" >Añadir Semestres</button>
        </a>
    ...
    <hr class="dirConfiguraciones__instituto--hr">
            ...
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    <li>
                        <a data-toggle="tab" href="#tab-1">Semestres</a>
                    </li>
	...
	<form method="get">
		<div class="a-matricula__estudiantes">
			<input type="search" name="search" id="semester-search" placeholder="Buscar..." class="inputSearch" value="{{request()->search}}">
		</div>
	</form>

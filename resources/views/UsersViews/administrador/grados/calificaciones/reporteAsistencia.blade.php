			...
			<div class="pined-table-responsive">
				<table class="s-calificaciones w100">
					<tr class="table__bgBlue">
						<td class="no-border uppercase">Días de clase</td>
						<td class="no-border uppercase">Faltas</td>
						<td class="no-border uppercase">Faltas Justificados</td>
						<td class="no-border uppercase">Faltas Injustificados</td>
						<td class="no-border uppercase">Atrasados</td>
					</tr>
					<tr>

...
<div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="row wrapper white-bg titulo-separacion noBefore">
        <div class="col-xs-12 titulo-separacion">
            <h2 class="title-page">Estados de los Documentos de Estudiantes Instituto Superior Técnico Rey David</h2>
            <div class="agregarSeccionCont">
                <a href="{{ route('newStatusDoc') }}">
                    <button class="btn btn-primary">Agregar Nuevo Estado</button>
                </a>
            </div>
        </div>   

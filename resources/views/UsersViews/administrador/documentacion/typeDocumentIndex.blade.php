...
<div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="row wrapper white-bg titulo-separacion noBefore">
        <div class="col-xs-12 titulo-separacion">
            <h2 class="title-page">Tipos de Documentos Aceptados Instituto Superior Técnico Rey David</h2>
            <a href="{{ route('tdCreate') }}">
                <button class="btn btn-primary">Agregar Nuevo Tipo de Documento Aceptado</button>
            </a>
        </div>   
        ...
        <table id="tablaEstudiantes" class="table table-striped table-hover table-bordered white-bg">
            <thead>
                <tr>
                    ...
                    <th>Estado del Tipo de Documento</th>
                    <th>Acciones</th>
                </tr>
            </thead>
            <tfoot>
...
<script type="text/javascript"> 
    ...
    $(document).ready(function() {
                ...
                var tabla = $('#tablaEstudiantes').DataTable({
                    ...
                    responsive: true,
                    ajax: "{{ route('getTableTypeDocument')}}",
                    columns: [{
                            data: 'id',

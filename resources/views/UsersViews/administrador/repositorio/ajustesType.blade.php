...
<div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="row wrapper white-bg titulo-separacion noBefore">
        <div class="col-xs-12 titulo-separacion">
            <h2 class="title-page">Repositorio Ajustes Instituto Superior Técnico Rey David</h2>
            <div class="agregarSeccionCont">
                <a href="{{ route('newDocument') }}">
                    <button class="btn btn-primary" disabled>Agregar Tipo de Documento</button>
                </a>
            </div>
        </div>     
    </div>

...
@endif
    ...
    <div class="row wrapper white-bg titulo-separacion noBefore">
        <div class="col-xs-12 titulo-separacion">
            <h2 class="title-page">Estados de Documentos Instituto Superior Técnico Rey David</h2>
            <div class="agregarSeccionCont">
                <a href="{{ route('newStatus') }}">
                    <button class="btn btn-primary">Agregar un tipo de Estado de Documentos</button>
                </a>
            </div>
        </div>     
    </div>
    <div class="row wrapper" style="overflow-x: auto !important;">
        ...
        <div class="agregarSeccionCont">
		<a class="button-br" href="{{ route('repositorioAjustes') }}">
		    <button>

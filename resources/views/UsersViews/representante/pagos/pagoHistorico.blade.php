                ...
                <div class="header-pag-his">
                    <div class="notificacion">
                        <span class="mensajes">
                            ...
                            <label class="texto-mensajes">Histórico
                                <label>
                        </span>
                    </div>
                    ...
                    <div class="lista-prof">
                        <select onchange="selectProfAsist()" class="form-control select-prof-asist" id="select-quimestre">
                            <option value="Q1" selected>Quimestre 1</option>
                        ...
                        <table class="table table-pag-hist">
                            ...
                            <tbody>
                                <tr>
                                    <td>Matricula</td>
                                    <td>$80.00</td>
                                    <td class="pago-realizado">Realizada</td>
                                    <td>Cheque</td>
                                    <td class="pag-his-imp">
                                        <a href="#">
                                            <img src="img/IMPRIMIR.png" alt="" W width="30">
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Julio</td>
                                    <td>$80.00</td>
                                    <td class="pago-realizado">Realizado</td>
                        ...
                        <table class="table table-pag-hist">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td class="pag-his-imp no-factura">
                                        <a href="#">
                                    </td>
                                </tr>
                            </tbody>

			...
			<div class="ibox float-e-margins">
				<div class="ibox-content mailbox-content">
					<div class="file-manager">
						<a class="btn btn-block btn-primary compose-mail" href="{{ route('notificacionesEnviarRepresentante') }}"> Nuevo Correo</a>
					...
					<table id="tableNotificaciones" class="table table-hover table-mail tableNotificaciones">
						...
						<tbody>
							@foreach($messages as $message) 
								...
								<td class="text-left mail-date" width="100">{{ date('d-m-Y', strtotime($message->created_at)) }}
								</td>
								<td>
									@php

<div class="modal-dialog dirModalAgregarGrado modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title">Datos Generales del Estudiante</h3>
			</div>
			<div class="modal-body" >
				<form method="post" action="{{route('updateEstudiante',$data->id)}}" id="formActualizarEstudiante">
	...
	<div class="matricula__matriculacion-block">
		...
		<div>
			...
			<div class="matricula__matriculacion__input">
				...
				<input type="text" class="form-control input-sm" name="celular_estudiante" placeholder="Celular del estudiante" value="{{old('celular_estudiante', $dataProfile->telefono_movil)}}">
			</div>
	...
	<div class="matricula__matriculacion-block">
		...
		<div>
			...
			<div class="matricula__matriculacion__input">
				...
				<input type="text" class="form-control input-sm" name="telefono" minlength="8" maxlength="10" placeholder="Teléfonos de la residencia o movil del estudiante" value="{{old('telefono', $data->telefono)}}">
			</div>
			<div class="matricula__matriculacion__input">
...
$('#formActualizarEstudiante').submit(function(e){
    e.preventDefault()
     $.ajax({
            url: "{{route('updateEstudiante',$data->id)}}",
            type: "POST",
            data : $( this ).serialize(),

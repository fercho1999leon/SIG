    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row wrapper white-bg ">
                <div class="col-lg-12">
                    <h2 class="title-page">Planificación Curricular Institucional</h2>
                </div>
            </div>
            <div class="row mb350">
                <div class="col-lg-12">
                    <div class="widget widget-tabs bg-none">
                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a data-toggle="tab" href="#tab-1">Educación Inicial (EI)</a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#tab-2">Educación General Básica (EGB)</a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#tab-3">Bachillerato General Unificado (BGU)</a>
                                </li>
                            </ul>

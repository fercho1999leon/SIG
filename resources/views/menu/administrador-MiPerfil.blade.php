	...
	<div class="sidebar-collapse">
		<ul class="nav metismenu" id="side-menu">
			...
			<li>
				...
				<ul class="nav nav-second-level">
					<li>
						<a href="#" class="pagina-inactiva">Administrativos </a>
					</li>
					<li>
						<a href="#" class="pagina-inactiva">Docentes </a>
					</li>
					<li>
						<a href="#" class="pagina-inactiva">Estudiantes </a>
					</li>
					<!--
						<li>
							<a href="#" class="pagina-inactiva">.R. </a>
						</li>
					-->
				</ul>
			</li>
